...
struct ContactDTOV2 {
    ...
    private(set) var phoneNumbers: [PhoneNumberDTOV2]
    
    var primaryNumber: PhoneNumberDTOV2? {
    ...
    mutating func addPhoneNumber(_ phDto: PhoneNumberDTOV2) {
        if phDto.isPrimary {
